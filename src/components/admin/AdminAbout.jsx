        ...
        <div style={{ position: "sticky", top: 20 }}>
          ...
          <div style={{ background: "#0a0a0a", border: `0.5px solid ${G3}`, borderTop: `2px solid ${S}`, padding: 20 }}>
            <div style={{ marginBottom: 16, padding: 16, background: G1, border: `0.5px solid ${G3}` }}>
              ...
              <div style={{ display: "inline-block", background: "rgba(192,192,192,.1)", border: ".5px solid rgba(192,192,192,.2)", padding: "4px 10px", fontSize: 7, color: S, letterSpacing: 2, textTransform: "uppercase" }}>{settings.banner_text}</div>
            </div>
            <div style={{ marginBottom: 16, padding: 16, background: G1, border: `0.5px solid ${G3}` }}>
