...
const items = [
  { label: "Home", to: "/", icon: (active) => (
    <svg width="22" height="22" viewBox="0 0 24 24" fill={active ? S : "none"} stroke={active ? S : "#555"} strokeWidth="1.5">
      <path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>
    </svg>
  )},
  { label: "Shop", to: "/shop", icon: (active) => (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={active ? S : "#555"} strokeWidth="1.5">
  ...
  { label: "Wishlist", to: "/wishlist", icon: (active) => (
    <svg width="22" height="22" viewBox="0 0 24 24" fill={active ? S : "none"} stroke={active ? S : "#555"} strokeWidth="1.5">
