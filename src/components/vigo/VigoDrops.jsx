        ...
        <div style={{ position: "relative", overflow: "hidden", borderBottom: `.5px solid ${G3}`, background: `linear-gradient(135deg, #000 0%, #0a0a0a 50%, #050505 100%)` }}>
          ...
          <div style={{ maxWidth: 1100, margin: "0 auto", padding: "60px 24px" }}>
            <div className="vigo-hero-drop" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center" }}>
              <div>
                <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(192,192,192,.06)", border: `.5px solid rgba(192,192,192,.15)`, padding: "6px 14px", marginBottom: 24 }}>
                  <div style={{ width: 5, height: 5, borderRadius: "50%", background: "#0c6", animation: "vigo-pulse 1.5s infinite" }} />
                  <span style={{ fontSize: 8, letterSpacing: 4, color: S, textTransform: "uppercase" }}>Next Drop Live</span>
                </div>
