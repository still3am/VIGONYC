...
export default function VigoReturns() {
  ...
  return (
    <div style={{ padding: "64px 32px", maxWidth: 680, margin: "0 auto" }}>
      ...
      <div style={{ background: "var(--vt-card)", border: ".5px solid var(--vt-border)", borderLeft: "2px solid #C0C0C0", padding: "16px 20px", marginBottom: 32 }}>
        <div style={{ fontSize: 9, letterSpacing: 2, color: SD, textTransform: "uppercase", marginBottom: 8 }}>Return Policy</div>
        <div style={{ fontSize: 11, color: SD, lineHeight: 1.8 }}>Regular items: 14 days from delivery. Drop & limited-edition items: final sale, no exceptions. Items must be unworn, unwashed, with tags attached.</div>
      </div>
      ...
      {submitted ? (
        <div style={{ background: G1, border: `.5px solid ${G3}`, borderTop: `2px solid #0c6`, padding: "48px 36px", textAlign: "center" }}>
          ...
          <div style={{ fontSize: 12, color: SD, lineHeight: 1.8 }}>
            ...
            We'll contact you {settings.contact_response_time || "within 24 hours"} with next steps.
          </div>
        </div>
      ) : (
